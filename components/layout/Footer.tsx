      ...
      <div className="max-w-[1920px] mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-1">
            ...
            <p className="text-zinc-200 text-sm max-w-xs mb-6">
              The premier streaming destination for live boxing, replays, and pay-per-view events.
            </p>
            <div className="flex items-center gap-2 text-sm text-zinc-200 cursor-pointer hover:text-[#eaff04] transition-colors">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-zinc-200">
              ...
              <li><a href="https://narapromotionz.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#eaff04] transition-colors">Nara Promotionz</a></li>
        ...
        <div className="pt-8 border-t border-nara-border flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-zinc-200">
          <p>&copy; {new Date().getFullYear()} Nara Promotionz / Nara TV. All rights reserved.</p>
          <div className="flex gap-4">
            <Link href="/imprint" className="hover:text-[#eaff04]">Imprint</Link>
