      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8">
         ...
         <div className="relative w-full mb-16">
            ...
            <input 
              ...
              className="w-full bg-[#0B1626] border border-white/10 text-white px-16 py-6 rounded-sm outline-none focus:border-white transition-colors text-lg font-bold placeholder:text-gray-600"
            />
         </div>

         <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <a href="#" className="bg-[#0B1626] border border-white/10 p-6 rounded-sm hover:border-[#45E3FF]/50 transition-colors group">
               <HelpCircle className="w-8 h-8 text-[#45E3FF] mb-4" />
            ...
            <a href="#" className="bg-[#0B1626] border border-white/10 p-6 rounded-sm hover:border-[#45E3FF]/50 transition-colors group">
               <Play className="w-8 h-8 text-[#45E3FF] mb-4" />
         ...
         <div className="space-y-4 mb-16">
            {faqs.map((faq, i) => (
               <details key={i} className="group bg-[#0B1626] border border-white/10 rounded-sm">
         ...
         <div className="bg-[#0B1626] border border-white/10 p-8 md:p-12 text-center rounded-sm">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
               <button className="bg-[#172338] hover:bg-[#22314B] text-white font-bold uppercase tracking-widest py-4 px-8 rounded-sm transition-colors flex items-center gap-2 w-full sm:w-auto justify-center">
